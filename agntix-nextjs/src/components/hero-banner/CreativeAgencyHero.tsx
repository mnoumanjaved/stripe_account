...
const CreativeAgencyHero = ({ title = "Brainstorm.ai", fontStyle="" }) => {
          ...
          <ImageTrail images={images}/>
            <div className="container container-1830">
                <div className="studio-hero-bg">
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="studio-hero-info z-index-5 d-flex justify-content-md-between justify-content-center align-items-center">
                                <Link href="mailto:hello@brainstorm.ai" style={{ fontSize: '16px' }}>hello@brainstorm.ai</Link>
                                <span style={{ fontSize: '18px', fontWeight: '500' }}>AI-Powered <br /> Brainstorming</span>
                                <Link href="mailto:hello@brainstorm.ai" style={{ fontSize: '16px' }}>hello@brainstorm.ai</Link>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="studio-hero-content text-center tp-text-perspective" data-delay="1.2" data-fade-from="top" data-ease="bounce">
                                <h2 className={`studio-hero-title ${fontStyle}`} style={{
